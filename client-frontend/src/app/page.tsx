    ...
    {/* Navigation */}
     ...
     <header className="relative bg-blue-500 h-screen flex items-center justify-center text-white">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          <h1 className="text-4xl font-bold mb-4">Welcome to Your Agri Marketplace</h1>
          <p className="text-lg">Discover fresh and quality agricultural products.</p>
        </div>
      </header>
    ...
    <section className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-4 rounded-md shadow-md w-72">
          <img src="/sample-product.jpeg" alt="Product" className="mb-4 w-full h-32 object-cover rounded-md" />
